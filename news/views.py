...
class MailingListView(ListView):
    model = Mailing
    template_name = 'news/mailing_list.html'
...
class MailingCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'news/create_mailing.html'
    ...
    def get_success_url(self):
        return reverse_lazy('news:create_message', kwargs={'mailing_pk': self.mailing_pk})


class MailingUpdateView(LoginRequiredMixin, UpdateView):
    model = Mailing
    fields = ('start_time', 'frequency', 'recipients', 'status')
    success_url = reverse_lazy('news:mailing')
...
class MailingDetailView(DetailView):
    model = Mailing
    template_name = 'news/mailing_detail.html'
...
class ClientListView(ListView):
    model = Client
    template_name = 'news/client_list.html'
...
class MessageCreateView(LoginRequiredMixin, CreateView):
    ...
    template_name = 'news/create_message.html'
    success_url = reverse_lazy('news:mailing')
...
class DeliveryReportView(ListView):
    model = Log
    template_name = 'news/delivery_report.html'
